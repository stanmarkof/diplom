        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatDialogs_AspNetUsers_User1Id",
                        column: x => x.User1Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatDialogs_AspNetUsers_User2Id",
                        column: x => x.User2Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetrievedChunks = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OllamaResponse = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RagQueryLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RagQueryLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DisciplineGroups", x => new { x.DisciplinesId, x.StudentGroupsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Materials_Disciplines_DisciplineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RagDocuments_Disciplines_DisciplineId",
                        column: x => x.DisciplineId,
                        principalTable: "Disciplines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RagDocuments_Materials_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatDialogs_User1Id_User2Id",
                table: "ChatDialogs",
                columns: new[] { "User1Id", "User2Id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChatDialogs_User2Id",
                table: "ChatDialogs",
                column: "User2Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materials_DisciplineId",
                table: "Materials",
                column: "DisciplineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RagChunks_DocumentId",
                table: "RagChunks",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_RagDocuments_DisciplineId_AccessLevel",
                table: "RagDocuments",
                columns: new[] { "DisciplineId", "AccessLevel" });

            migrationBuilder.CreateIndex(
                name: "IX_RagDocuments_MaterialId",
                table: "RagDocuments",
                column: "MaterialId",
                unique: true,
